    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthSessionTickets", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerHistoryEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerHistoryEntries_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerHistoryEntries_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImpersonationSessions_AdminUserId_EndedAt",
                table: "ImpersonationSessions",
                columns: new[] { "AdminUserId", "EndedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ImpersonationSessions_TargetUserId_EndedAt",
                table: "ImpersonationSessions",
