...
namespace Matbiz.Web.Data.Migrations
{
    ...
    [Migration("20260604215213_AddArticleCustomFields")]
    partial class AddArticleCustomFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Matbiz.Web.Modules.Articles.Models.ArticleCustomFieldValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ArticleId", "FieldDefinitionId")
                        .IsUnique();

                    b.ToTable("ArticleCustomFieldValues");
                });

            modelBuilder.Entity("Matbiz.Web.Modules.Articles.Models.ArticleFieldDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ArticleFieldDefinitions");
                });

            modelBuilder.Entity("Matbiz.Web.Modules.Articles.Models.ArticleFieldSection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ArticleFieldSections");
                });
            ...
            modelBuilder.Entity("Matbiz.Web.Modules.Articles.Models.ArticleCustomFieldValue", b =>
                {
                    ...
                    b.HasOne("Matbiz.Web.Modules.Articles.Models.ArticleFieldDefinition", "FieldDefinition")
                        .WithMany()
            ...
            modelBuilder.Entity("Matbiz.Web.Modules.Articles.Models.ArticleFieldDefinition", b =>
                {
                    b.HasOne("Matbiz.Web.Modules.Articles.Models.ArticleFieldSection", "Section")
                        .WithMany("Fields")
